...
namespace DemoTMS.Controllers
{
    public class MasterUsersController : Controller
    {
        ...
        public MasterUsersController(SolutionContext context)
        {
            _context = context;
        }
        ...
        // GET: MasterUsers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MasterUsers/Create
        ...
        {
            return _context.MasterUsers.Any(e => e.Id == id);
        }
    }
}
